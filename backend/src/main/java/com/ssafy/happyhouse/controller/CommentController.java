...
import com.ssafy.happyhouse.model.service.CommentServiceImpl;
...
public class CommentController {
	...
	@GetMapping("{bno}")
	public ResponseEntity<List<CommentDto>> listComment(@PathVariable("bno") int bno) {
		logger.debug("listComment - 호출");
		return new ResponseEntity<List<CommentDto>>(commentService.list(bno), HttpStatus.OK);
	}
